  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        ...
        "data-[state=checked]:bg-[#E9F9E4] data-[state=checked]:border-[#6DD230] data-[state=checked]:text-[#6DD230]",
        className
      )}
      {...props}
    >
      <CheckboxPrimitive.Indicator
        ...
        className="flex items-center justify-center text-[#6DD230] transition-none"
      >
